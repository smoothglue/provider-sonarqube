...
PROJECT_REPO ?= github.com/smoothglue/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= jdamata/sonarqube
export TERRAFORM_PROVIDER_REPO ?= https://github.com/jdamata/terraform-provider-sonarqube
export TERRAFORM_PROVIDER_VERSION ?= 0.16.14
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-sonarqube
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://github.com/jdamata/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/releases/download/v$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-sonarqube_v0.16.14
...
REGISTRY_ORGS ?= ghcr.io/smoothglue
IMAGES = $(PROJECT_NAME)
...
XPKG_REG_ORGS ?= ghcr.io/smoothglue
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= ghcr.io/smoothglue
XPKGS = $(PROJECT_NAME)
