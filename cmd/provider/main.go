...
import (
	...
	"github.com/smoothglue/provider-sonarqube/apis"
	"github.com/smoothglue/provider-sonarqube/apis/v1alpha1"
	"github.com/smoothglue/provider-sonarqube/config"
	"github.com/smoothglue/provider-sonarqube/internal/clients"
	"github.com/smoothglue/provider-sonarqube/internal/controller"
	"github.com/smoothglue/provider-sonarqube/internal/features"
)

func main() {
	var (
		app                     = kingpin.New(filepath.Base(os.Args[0]), "Terraform based Crossplane provider for SonarQube").DefaultEnvars()
	...
	kingpin.FatalIfError(apis.AddToScheme(mgr.GetScheme()), "Cannot add SonarQube APIs to scheme")
	...
	kingpin.FatalIfError(controller.Setup(mgr, o), "Cannot setup SonarQube controllers")
